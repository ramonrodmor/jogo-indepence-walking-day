...
#include "Types.h"				// tipos do motor 
...
public:
	...
	llong TimeStamp();			// retorna valor atual do contador
	float Elapsed(llong t);		// retorna tempo transcorrido a partir da estampa
}; 
